...
describe('App component', () => {
  ...
  const cases = [
    { interactionType: 'buttons', configFile: 'buttons_test.json' },
    { interactionType: 'drop', configFile: 'drop_4_option_test.json' },
    { interactionType: 'write', configFile: 'write_test.json' }
  ];

  cases.forEach(({ interactionType, configFile }) => {
    it('Should communicate via postMessages when the app is in iframe', () => {
